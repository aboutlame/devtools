...
class ProgressTrackerTest {
  ...
  @Test
  void shouldReturnNoDataMessageWhenMenteesIsNull() {
  ...
  @Test
  void shouldReturnNoDataMessageWhenMenteesIsEmpty() {
    ProgressTracker tracker = new ProgressTracker();
  ...
  @Test
  void shouldCalculateProgressWhenOneMenteeProvided() {
    ProgressTracker tracker = new ProgressTracker();
  ...
  @Test
  void shouldCalculateProgressWhenMultipleMenteesProvided() {
    ProgressTracker tracker = new ProgressTracker();
  ...
  @Test
  void shouldReturnZeroRemainingWhenAllLessonsCompleted() {
    ProgressTracker tracker = new ProgressTracker();
  ...
  @Test
  void shouldPrintTotalProgressWhenMainIsExecuted() {
